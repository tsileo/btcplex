// THIS FILE IS AUTO-GENERATED FROM docs_sse_api.tmpl
// DO NOT EDIT.
...
func init() {
	Files.Add("docs_sse_api.tmpl", 5717, time.Unix(0, 1393190021994998573), fileembed.String("<h2>Server-Sent Events API Documentation</h2>\n"+
		...
		"\n"+
		"<div class=\"col-md-9\">\n"+
		"<p class=\"lead\">The <a href=\"https://developer.mozilla.org/en-US/docs/Server-sent"+
		"_events/Using_server-sent_events\">Server-Sent Events</a> API allows you to get no"+
		"tified on events.</p>\n"+
		"\n"+
		"<h3>Path</h3>\n"+
		"\n"+
